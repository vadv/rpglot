...
use super::widgets::{
    calculate_summary_height, render_header, render_help, render_pg_detail, render_pg_statements,
    render_pgs_detail, render_postgres, render_process_detail, render_processes,
    render_quit_confirm, render_summary, render_time_jump,
};

/// Main render function.
pub fn render(frame: &mut Frame, state: &mut AppState, interner: Option<&StringInterner>) {
    let area = frame.area();
