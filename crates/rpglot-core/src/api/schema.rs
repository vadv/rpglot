...
fn generate_pgp_schema() -> TabSchema {
    TabSchema {
        name: "pg_store_plans".into(),
        description: "PostgreSQL plan statistics".into(),
        entity_id: "planid".into(),
        columns: vec![
            col(
                "planid",
                "Plan ID",
            ...
            col("user", "User", DataType::String, None, None, true, true),
            col("query", "Query", DataType::String, None, None, false, true),
            col("plan", "Plan", DataType::String, None, None, false, true),
            col("calls", "Calls", DataType::Integer, None, None, true, false),
            col("rows", "Rows", DataType::Integer, None, None, true, false),
            col(
                "mean_time_ms",
